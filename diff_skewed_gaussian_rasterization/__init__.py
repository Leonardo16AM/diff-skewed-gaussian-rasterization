...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        ctx.save_for_backward(colors_precomp, means3D, scales, skews, skew_sensitivity, rotations, cov3Ds_precomp, radii, sh, opacities, geomBuffer, binningBuffer, imgBuffer)
    ...
    def backward(ctx, grad_out_color, _, grad_out_depth):
        ...
        colors_precomp, means3D, scales, skews, skew_sensitivity, rotations, cov3Ds_precomp, radii, sh, opacities, geomBuffer, binningBuffer, imgBuffer = ctx.saved_tensors
...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, shs = None, colors_precomp = None, scales = None, skews= None, skew_sensitivity=None, rotations = None, cov3D_precomp = None):
